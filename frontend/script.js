...
function setupLoginScreen() {
    ...
    // เข้าสู่ระบบด้วย Google (ท่าไม้ตาย: แก้ปัญหา Popup Blocked + ปุ่มค้าง)
    googleLoginBtn.onclick = () => {
        const originalGoogleBtnHtml = `
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="18" height="18" style="margin-right:8px;">
        ...
        // บรรทัดแรกต้องเรียก Popup ทันที
        ...
        window.signInWithPopup(window.firebaseAuth, window.googleProvider)
            .then(() => {
                // คืนค่าปุ่มทันทีเพื่อพร้อมใช้งานรอบหน้า (หลัง Logout)
            ...
            .catch((error) => {
                ...
                if (error.code === 'auth/popup-blocked') {
                    alert('⚠️ Browser บล็อกหน้าต่างล็อกอิน! กรุณากด "อนุญาต (Allow Pop-ups)" ที่มุมขวาบนครับ');
        ...
        googleLoginBtn.innerHTML = `<i class="fa fa-spinner fa-spin"></i> <span>Connecting...</span>`;
    };
